...
namespace Photon.Pun.Demo.PunBasics
{
	...
	public class CameraWork : MonoBehaviour
	{
		...
		///     Use this when you don't know at the time of editing what to follow, typically instances managed by the photon
		///     network.
		/// </summary>
		...
		///     For example a follow camera should always be implemented in LateUpdate because it tracks objects that might have
		///     moved inside Update.
		/// </summary>
		...
		private void Apply()
		{
			var targetCenter = transform.position + centerOffset;
